      ...
      <Scene key="root">
        ...
        <Scene key="tabbar" tabs={true} tabBarStyle={{ backgroundColor: "#FFFFFF" }} hideNavBar>
          <Scene key="Home" icon={TabIcon}>
            ...
            <Scene key="license" component={License} navTransparent={true} hideTabBar={true} />
            <Scene key="addlc" component={Addlc} navTransparent={true} hideTabBar={true} />
            <Scene key="payment" component={Payment} navTransparent={true} hideTabBar={true} />
            <Scene key="addcard" component={Addcard} navTransparent={true} hideTabBar={true} />
          </Scene>
          ...
          <Scene key="Access" icon={TabIcon}>
            ...
            <Scene key="time" component={Time} navTransparent={true} titleStyle={{color:'#FFFFFF'}} headerTintColor="#ffffff" hideNavBar={false} hideTabBar={true} />
            <Scene key="share" component={Share} navTransparent={true} titleStyle={{color:'#FFFFFF'}} headerTintColor="#ffffff" hideNavBar={false} hideTabBar={true} />
          </Scene>
